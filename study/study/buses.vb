...
Public Class buses
    ...
    Private Sub RefreshDataGridView()
        ...
        Using connection As New SqlConnection(connectionString)
            ...
            Dim query As String = "SELECT prak,category,numbers FROM buses"
    ...
    Private Sub Button7_Click(sender As Object, e As EventArgs) Handles DeleteDataButton.Click
        ...
        Using connection As New SqlConnection(connectionString)
            ...
            Dim deleteQuery As String = "DELETE FROM buses WHERE prak = @pk"
    ...
    Private Sub update_Click(sender As Object, e As EventArgs) Handles update.Click
        ...
        If String.IsNullOrWhiteSpace(pkToUpdate) Then
            MessageBox.Show("Please enter a PraK NUMBER value to update.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Return
        End If
        ...
        Using connection As New SqlConnection(connectionString)
            ...
            Dim updateQuery As String = "UPDATE buses SET category = @ct, numbers = @number WHERE prak = @pk"
            Using updateCommand As New SqlCommand(updateQuery, connection)
                ...
                Else
                    MessageBox.Show("No record found with the specified PRAK NUMBER.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
                End If
            End Using
        End Using
    End Sub
