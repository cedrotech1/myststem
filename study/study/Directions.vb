...
Public Class Directions
    ...
    Private Sub RefreshDataGridView()
        ...
        Using connection As New SqlConnection(connectionString)
            ...
            Dim query As String = "SELECT direction,price FROM directions"
    ...
    Private Sub DeleteDataButton_Click(sender As Object, e As EventArgs) Handles DeleteDataButton.Click
        ...
        If String.IsNullOrWhiteSpace(pkToDelete) Then
            MessageBox.Show("Please enter a Direction  delete.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Return
        End If
        ...
        Using connection As New SqlConnection(connectionString)
            ...
            Dim deleteQuery As String = "DELETE FROM directions WHERE direction = @pk"
            Using deleteCommand As New SqlCommand(deleteQuery, connection)
                ...
                If rowsAffected > 0 Then
                    ...
                    RefreshDataGridView()
                Else
                    MessageBox.Show("No record found with the specified direction.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
                End If
            End Using
        End Using
    End Sub
    ...
    Private Sub update_Click(sender As Object, e As EventArgs) Handles update.Click
        ...
        If String.IsNullOrWhiteSpace(pkToUpdate) Then
            MessageBox.Show("Please enter a direction value to update.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Return
        End If
        ...
        Using connection As New SqlConnection(connectionString)
            ...
            Dim updateQuery As String = "UPDATE directions SET direction = @pk, price = @new WHERE direction = @pk"
